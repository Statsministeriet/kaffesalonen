...
<body>
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="./en/index.php" class="flagIcon"><img src="./Media/uk.png" /><p class="textForSmallMenu">English</p></a>
    ...
    <div class="videoContainerMobile">
        <img src="./Media/images/novideo.png"/>
    </div>

    <div class="bookTableButtonVideo">
        <a onclick="openTableNav()">
            <img src="./Media/BookBord.png"></img>
        </a>
    ...
    <div class="box">
        ...
        <div class="textbox">
            <h1 id="imageTextH1"><cms:editable name='cafe_afsnit_overskrift' desc='Overskrifte i cafe afsnittet' type='text'/></h1>
            <p id="imageTextP">
            <cms:editable name='cafe_afsnit_tekst' desc='Teksten i cafe afsnittet' type='richtext'/>
            </p>
    ...
    <div class="boxPhone">
        <div class="lazy" id="imageTextIMG" data-src="./Media/images/cafe.jpg"></div>
        <div class="textbox">
            <h1 id="imageTextH1"><cms:show cafe_afsnit_overskrift/></h1>
            <p id="imageTextP"><cms:show cafe_afsnit_tekst/></p>
    ...
    <div class="box">
        <div class="textbox">
        <h1 id="imageTextH1"><cms:editable name='pavillonen_afsnit_overskrift' desc='Overskrifte i pavilionen afsnittet' type='text'/></h1>
            <p id="imageTextP">
            <cms:editable name='pavillonen_afsnit_tekst' desc='Teksten i pavilionen afsnittet' type='richtext'/>
            </p>
        </div>
    ...
    <div class="boxPhone">
        <div class="lazy" id="imageTextIMG" data-src="./Media/images/pavillionen.jpg"></div>
        <div class="textbox">
            <h1 id="imageTextH1"><cms:show pavillonen_afsnit_overskrift/></h1>
            <p id="imageTextP"><cms:show pavillonen_afsnit_tekst/></p>
    ...
    <div class="box">
        ...
        <div class="textbox">
            <h1 id="imageTextH1"><cms:editable name='svaner_afsnit_overskrift' desc='Overskrifte i svaner afsnittet' type='text'/></h1>
            <p id="imageTextP">
            <cms:editable name='svaner_afsnit_tekst' desc='Teksten i svaner afsnittet' type='richtext'/>
            </p>
            <div class="boatPricesContainer">
    ...
    <div class="boxPhone">
        <div class="lazy" id="imageTextIMG" data-src="./Media/images/svaner.jpg"></div>
        <div class="textbox">
            <h1 id="imageTextH1"><cms:show svaner_afsnit_overskrift/></h1>
            <p id="imageTextP"><cms:show svaner_afsnit_tekst/></p>
                <div class="boatPricesContainer">
                    <a onclick="openBoatNav()">
                        <div class="bookTableButton">
                            Priser
    ...
    <div class="box">
        <div class="textbox">
            <h1 id="imageTextH1"><cms:editable name='festlokaler_afsnit_overskrift' desc='Overskrifte i festlokaler afsnittet' type='text'/></h1>
            <p id="imageTextP"><cms:editable name='festlokaler_afsnit_tekst' desc='Tekst i festlokaler afsnittet' type='richtext'/>
            </p>
        </div>
    ...
    <div class="boxPhone">
        <div class="lazy" id="imageTextIMG" data-src="./Media/images/festlokaler.jpg"></div>
        <div class="textbox">
            <h1 id="imageTextH1"><cms:show festlokaler_afsnit_overskrift/></h1>
            <p id="imageTextP">
                <cms:show festlokaler_afsnit_tekst/>
            </p>
        </div>
    </div>
    ...
    <div class="box">
        ...
        <div class="textbox">
            <h1 id="imageTextH1"><cms:editable name='job_afsnit_overskrift' desc='Overskrifte i job afsnittet' type='text'/></h1>
            <p id="imageTextP">
            <cms:editable name='job_afsnit_tekst' desc='Overskrifte i job afsnittet' type='richtext'/>
            </p>
        </div>
    </div>
    <div class="boxPhone">
        <div class="lazy" id="imageTextIMG" data-src="./Media/images/job.jpg"></div>
        <div class="textbox">
            <h1 id="imageTextH1"><cms:show job_afsnit_overskrift/></h1>
            <p id="imageTextP">
                <cms:show job_afsnit_tekst/>
            </p>
        </div>
    </div>
